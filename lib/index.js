    ...
    for (var j = 0; j < jsDocComment.tags.length; j = j + 1) {
      ...
      if (tag.title === 'swagger') {
        try {
          ...
          // error is decorated with the local error message,
          // to have it displayed in the correct order
          e.commentError = 'failed to load comment\n' +
                           '===============================================\n' +
                           tag.description + '\n' +
                           '===============================================\n';
          throw e;
...
module.exports = function(options) {
  ...
  for (var i = 0; i < apiPaths.length; i = i + 1) {
    try {
      ...
      console.log('There was a problem while parsing file ' + apiPaths[i]);
      if (e.commentError) {
        console.log(e.commentError);
      }
      throw e;
    }
  }
